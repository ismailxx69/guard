...
module.exports.run = async (bot, message, args) => {
    ...
    if (!user.roles.find(`name`, "DCS | Muted")) return message.channel.sendEmbed(new Discord.RichEmbed().setColor('RANDOM').setTitle('Kişi Mutelenmemiş'))
    ...
    let muterole = message.guild.roles.find(`name`, "DCS | Muted");
