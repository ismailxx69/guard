...
exports.run = async (client, message, args) => {
  if(!message.member.roles.has(client.ayar.SahipRolüID) && !message.member.roles.has(client.ayar.TeyitYetkilisi)) return message.reply('Amaaa Kızıyorum Bak Olmaz Diyorum Olmazz!');
