...
exports.run = async (bot, message, args) => {
  if  (!message.member.roles.has("729271291525464134")) return message.reply('Bu komutu kullanmaya yetkin yok');
    ...
    message.channel.sendEmbed(new Discord.RichEmbed().setDescription(`<a:sytik:729283049090711563> ${rMember} **isimli üyeye \`${role.name}\` isimli yetki başarıyla verildi!** <a:sytik:729283049090711563> `).setColor('RANDOM'));
